...
const Skills: React.FC<SkillsProps> = (props) => {
    return (
        <div className="site-page-content">
            <h1>Skills</h1>
            <h3>in Web and Motion</h3>
            <br />
            <p>
                Click on one of the areas below to explore the skills in those areas.
                I've taken the time to include plenty of visual and interactive media to showcase each project.
                Enjoy!
            </p>
            <br />
