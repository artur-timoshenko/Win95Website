...
const LogoAnimation: React.FC<LogoAnimationProps> = () => {
    ...
    useEffect(() => {
        ...
        // if (!document.getElementById(id)) {
            ...
            template.innerHTML = `<template id="media-theme-reelplay">
            <style>
                :host {
                ...
                media-time-range {
                    ...
                    --media-range-bar-color: linear-gradient(to right, #000 1px, transparent 1px, transparent 7px) 7px 50% / 7px 3px repeat-x,
                    #008484;
            ...
            <div style={styles.videoContainer}>
                <div
                    ...
                    dangerouslySetInnerHTML={{
                        __html: `
              <media-theme template="media-theme-reelplay" style="width: 100%;">
                <video
                  slot="media"
                  src="${logoVideo}"
                  playsinline
